...
export default function DonationPage() {
  return (
    <div
      ...
      style={{
        backgroundImage: "url('https://cdn.vincef.org/banquet-2025/donation/donation-background.png?height=1080&width=1920&text=DonationBackground')",
        ...
        <div className="container mx-auto px-4 pt-20">
          <div className="grid grid-cols-1 items-center gap-8 py-12 md:grid-cols-2 md:py-24">
            <div className="relative aspect-video h-full w-full overflow-hidden rounded-lg bg-black/20 backdrop-blur-sm md:aspect-square">
              <Image src="https://cdn.vincef.org/banquet-2025/placeholder.svg?height=600&width=600" alt="Donation" fill className="object-cover" />
            </div>
